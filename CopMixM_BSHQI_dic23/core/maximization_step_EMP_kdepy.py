...
MAXIMIZATION STEPS BASED ON EMPIRICAL MARGINAL ESTIMATION METHOD with KDEpy
"""
#----------------------------------------------------------------------------
...
from utils.emp_distribution_23_new import emp_distr_kdepy
from scipy.optimize import Bounds
from copulae.copula.estimator.misc import is_archimedean, is_elliptical
import math
from copulae.core import pseudo_obs as pobs

def maximization_step_EMP_kdepy(self,X, clusters,resp, opt_max_EMP):
    N = float(X.shape[0])
    ...
    for cluster in clusters:
      ...
      #   bet_k = np.copy(cluster['bet_k'])
        ...
        (kde_pdf,ecdf)=emp_distr_kdepy(X,resp_nk,index_cluster,k)
